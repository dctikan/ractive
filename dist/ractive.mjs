...
if (hasConsole) {
  var welcomeIntro = [
    "%cRactive.js %c1.5.0-edge %cin debug mode, %cmore...",
    'color: rgb(114, 157, 52); font-weight: normal;',
    'color: rgb(85, 85, 85); font-weight: normal;',
    'color: rgb(85, 85, 85); font-weight: normal;',
    'color: rgb(82, 140, 224); font-weight: normal; text-decoration: underline;'
  ];
  var welcomeMessage = "You're running Ractive 1.5.0-edge in debug mode - messages will be printed to the console to help you fix problems and optimise your application.\n\nTo disable debug mode, add this line at the start of your app:\n  Ractive.DEBUG = false;\n\nTo disable debug mode when your app is minified, add this snippet:\n  Ractive.DEBUG = /unminified/.test(function(){/*unminified*/});\n\nGet help and support:\n  http://ractive.js.org\n  http://stackoverflow.com/questions/tagged/ractivejs\n  http://groups.google.com/forum/#!forum/ractive-js\n  http://twitter.com/ractivejs\n\nFound a bug? Raise an issue:\n  https://github.com/ractivejs/ractive/issues\n\n";
...
function findFirstUnclosed(str, tagName) {
  var needle = '<\\/?' + tagName;
  var regex = regExpCache$1[needle] || (regExpCache$1[needle] = new RegExp(needle, 'g'));
...
if (win && !win.Ractive) {
  ...
  warn("Ractive already appears to be loaded while loading 1.5.0-edge.");
}
...
//# sourceMappingURL=/ractive/.gobble-build/10-transpile/.cache/ractive.mjs.map
